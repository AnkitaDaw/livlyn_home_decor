                        ...
                        <div className="col-md-4 col-sm-6 col-12">
                            <div className="benefit_box px-4 mb-4 mb-md-0">
                                ...
                                <div className="benefit_text text-center">
                                    ...
                                    <p className="mb-0">Decorate your space with eco-friendly furniture with low VOCs, environmentally friendly materials and safe coatings.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-6 col-12">
                            <div className="benefit_box bordered px-4 py-4 py-md-0 mb-4 mb-md-0">
                                ...
                                <div className="benefit_text text-center">
                                    ...
                                    <p className="mb-0">We choose raw materials from the best manufacturers, so our furniture and decor are of the highest quality at the best prices.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-6 col-12">
                            <div className="benefit_box px-4">
                                ...
                                <div className="benefit_text text-center">
                                    ...
                                    <p className="mb-0"> We will deliver to your door anywhere in the world. If you're not 100% satisfied, let us know within 30 days and we'll solve the problem.</p>
                                </div>
                            </div>
                        </div>
                    </div>
